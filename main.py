...
def generateAnnouncement(filename):
    ...
    for index, item in df.iterrows():
        ...
        folder_file=f"announcement_{item['train_no']}_{index+1}.mp3"
        destination_file=os.path.join(folder,folder_file)
        announcement.export(destination_file, format="mp3")
...
if __name__ == "__main__":
    ...
    generateAnnouncement("Mumbai_trains.xlsx")
